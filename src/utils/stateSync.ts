// State synchronization utility for cross-component updates
...
class StateSyncManager {
  ...
  debouncedRefreshOrders(delay: number = 300) {
    this.clearTimeouts();
  ...
  debouncedRefreshAll(delay: number = 500) {
    this.clearTimeouts();
  ...
  // Preserve state across component navigation
