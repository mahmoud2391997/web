...
import { GamepadIcon, ShoppingCartIcon, CalendarIcon, DollarSignIcon, DatabaseIcon, CogIcon, ClipboardListIcon } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      ...
      <Tabs defaultValue="rooms" className="space-y-4">
        <TabsList className="grid w-full grid-cols-7 bg-slate-800 border-0 text-xs">
